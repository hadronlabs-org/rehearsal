...
CHANNEL_ID="channel-964"
PORT_ID="icahost"
RESET_SEQUENCE="1"

echo "Patching Cosmoshub genesis for ICA sync recovery..."
...
echo "Done. Patched Cosmoshub genesis written to $OUTPUT_GENESIS_FILE"
